import { dirname, constantinople } from "../deps.js";
import walk from "../walk.js";
import error from "../error.js";

export default function handleFilters(ast, filters, options, filterAliases) {
  options = options || {};
  walk(
    ast,
    function (node) {
      ...
      function filterWithFallback(filter, text, attrs, funcName) {
        try {
          ...
          if (filters && filters[filterName]) {
            ...
            throw new Error("jstransformer filters not supported");
          }
        } catch (ex) {
