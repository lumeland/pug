...
import { doctypes, selfClosing, stringify } from "./deps.js";
...
function toConstant(src) {
  return constantinople.toConstant(
    src,
    { pug: runtime, pug_interp: undefined },
  );
}
...
Compiler.prototype = {
  ...
  buffer: function (str) {
    ...
    if (
      ...
      this.buf[this.lastBufferedIdx - 1] = "pug_html = pug_html + " +
